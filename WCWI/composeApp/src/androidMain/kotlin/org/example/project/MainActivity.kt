...
// Minimal client factory to satisfy existing usage without changing behavior intentions.
// Provides a Ktor HttpClient with WebSockets support and the default engine.
private fun platformHttpClient(): HttpClient = HttpClient {
                ...
                Row(
                    ...
                    TextField(
                        ...
                        colors = TextFieldDefaults.colors(
                            focusedContainerColor = Color(red = 171 , green = 96 , blue = 10 , alpha = 10), //0xFFab600a80
                            unfocusedContainerColor = Color(red = 171, green = 96 ,  blue = 10 , alpha = 10),
